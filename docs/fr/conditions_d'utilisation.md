...
* Le contenu public est à la fois librement accessible et repérable par la recherche. Les déposants peuvent demander que le contenu public soit frappé d’embargo pour une période ne dépassant pas un an, à moins d’approbation contraire du gestionnaire de services. Les déposants doivent motiver adéquatement toute demande d’embargo, comme par exemple le fait de rendre le contenu accessible au public mettrait en péril une publication à venir. Les demandes d’embargo doivent avoir une date d’expiration explicite. Les demandes d’embargo d’un an ou moins seront accordées à la discrétion d’un curateur. Après la période d’embargo, le contenu deviendra accessible au public, à moins d’indication contraire des lois sur la protection des données et la protection de la vie privée.
